...
var pc;
var socket;
var initiator = window.location.toString().indexOf('init') > -1;
var started = false;
...
function createPeerConnection() {
  var pc_config = {"iceServers":[
      ...
      {"url":"turn:1370991380@54.244.14.244:80","credential":"LzipPd3bhpGqj09BaoKNDAPmpuM="},
      {"url":"turn:1370991380@54.244.14.244:80?transport=tcp","credential":"LzipPd3bhpGqj09BaoKNDAPmpuM="},
    ]};
...
function sendMessage(message) {
  ...
  fayeClient.publish('/messages', message)
}
